                                        ...
                                        <div class="hall-layout position-relative text-center mt-4">
                                            ...
                                            <div class="row justify-content-center mt-4">
                                                @foreach ($tables as $table)
                                                    <div
                                                        class="col-6 col-md-4 col-lg-3 d-flex justify-content-center mb-4">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Anda telah memilih meja <strong><span id="selectedTableNo"></span></strong>. Adakah anda pasti
                        untuk memilih No. Meja ini?</p>
