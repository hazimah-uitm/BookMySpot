        ...
        <div class="container-fluid">
                    ...
                    <div class="card bg-light text-dark shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <a href="{{ route('staff.booking.print', $booking->id) }}" class="btn btn-primary w-100 mt-0" target="_blank">
            ...
            @else bg-secondary text-light @endif"
                                            ...
                                            <div class="table-info">
                                                ...
                                                <p style="font-size: 10px; font-weight:bold">{{ $booking->staff->name }}</p>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
