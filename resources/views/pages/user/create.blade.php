        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ $save_route }}">
                ...
                <div class="mb-3">
                    ...
                    @if ($errors->has('email'))
                        <div class="invalid-feedback">Sila isi Alamat Emel</div>
                    @endif
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if ($errors->has('office_phone_no'))
                        <div class="invalid-feedback">Sila isi No. Telefon Pejabat</div>
                    @endif
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if ($errors->has('position_id'))
                        <div class="invalid-feedback">Sila pilih Jawatan</div>
                    @endif
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if ($errors->has('campus_id'))
                        <div class="invalid-feedback">Sila pilih Kampus</div>
                    @endif
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if ($errors->has('roles'))
                        <div class="invalid-feedback d-block">Sila pilih Peranan Pengguna</div>
                    @endif
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if ($errors->has('publish_status'))
                        <div class="invalid-feedback d-block">Sila pilih Status Pengguna</div>
                    @endif
                </div>
